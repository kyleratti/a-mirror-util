...
exports.logger = pino_1.default(Object.assign({ level: configurator_1.default.logger.level }, ecs_pino_format_1.default), pino_multi_stream_1.multistream(streams));
exports.logger.info({
